...
const getProfilePicture = async(req,res)=>{
    try{
        ...
        const user = await User.findById(userId).select('profilePicture firstName');
...
module.exports = {register, login,logout,adminRegister,deleteProfile, updateProfilePicture, getProfilePicture};